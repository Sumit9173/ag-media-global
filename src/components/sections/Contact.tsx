...
export function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsappMessage = `Hello AG Media!
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-32 items-center">
          ...
          >
            ...
            <div className="flex flex-col gap-10">
              ...
              <div className="flex items-center gap-8 group">
                <div className="w-16 h-16 rounded-2xl glass-orange flex items-center justify-center text-[#ff6b00] group-hover:scale-110 group-hover:bg-[#ff6b00] group-hover:text-white transition-all duration-500 shadow-xl group-hover:shadow-[#ff6b00]/20">
                ...
                <div>
                  ...
                  <a href="mailto:agmediaglobal76@gmail.com" className="text-xl md:text-2xl text-white font-bold hover:text-[#ff6b00] transition-colors font-[var(--font-space-grotesk)]">
                    agmediaglobal76@gmail.com
                  </a>
                </div>
              </div>
              ...
              {/* Phone */}
              <div className="flex items-center gap-8 group">
                <div className="w-16 h-16 rounded-2xl glass flex items-center justify-center text-white group-hover:scale-110 group-hover:bg-white group-hover:text-black transition-all duration-500 shadow-xl">
                  <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <motion.div
            ...
            className="glass rounded-[2.5rem] p-10 md:p-14 relative overflow-hidden shadow-2xl border-white/10"
          >
            {/* Form Glow */}
            ...
            <form className="flex flex-col gap-8 relative z-10" onSubmit={handleSubmit}>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="relative">
                  <input type="text" id="name" value={formData.name} onChange={handleChange} placeholder="Name" required className={inputStyles} />
                  <label htmlFor="name" className={labelStyles}>Your Name</label>
                </div>
                <div className="relative">
                  <input type="text" id="brand" value={formData.brand} onChange={handleChange} placeholder="Brand" required className={inputStyles} />
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="relative">
                  <input type="email" id="email" value={formData.email} onChange={handleChange} placeholder="Email" required className={inputStyles} />
                  <label htmlFor="email" className={labelStyles}>Email Address</label>
                </div>
                <div className="relative">
                  <input type="tel" id="phone" value={formData.phone} onChange={handleChange} placeholder="Phone" required className={inputStyles} />
                  <label htmlFor="phone" className={labelStyles}>Phone Number</label>
                </div>
              </div>

              <div className="relative">
                <textarea id="message" value={formData.message} onChange={handleChange} rows={5} placeholder="Message" required className={`${inputStyles} resize-none`} />
                <label htmlFor="message" className={labelStyles}>Tell us about your goals</label>
              </div>

              <button type="submit" className="group relative w-full py-5 px-8 text-white font-black text-lg rounded-2xl overflow-hidden mt-6 transition-all duration-500 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center">
